...
if __name__ == "__main__":
    ...
    # import secp256k1
    # public_inbox_key = secp256k1.PrivateKey(bytes.fromhex('13bad4c07bdea3a3397e7f52824d77c8a01b8edcc328f0ca5dd8e2540df5efb5'))
    # se = SharedEncrypt(public_inbox_key.serialize())
    # print(se.get_shared_key('025a5373396fe3fb30213adcc189a79d3c6d6c03b6a3e8320e6178a025e52e31c2'))
    #
    # print(se.shared_key)
