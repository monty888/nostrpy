...
//                    '</div>',
        ...
        'channel-view-post-area': [
            '<div style="margin-bottom:0px!important;display:none;" class="input-group mb-2" id="reply-info" >',
                '<span id="reply-info-txt" style="display:inline-block;width: calc(100% - 64px);background-color:white;color:black;white-space:nowrap;text-overflow: ellipsis;overflow:hidden;"></span>',
                '<button style="background-color:white" id="reply-cancel-but" type="button" class="btn" aria-label="filter" >',
                    '<svg style=";color:black" class="nbi-btn">',
                        '<use xlink:href="/bootstrap_icons/bootstrap-icons.svg#file-x"/>',
                    '</svg>',
                '</button>',
            '</div>',
            '<div class="input-group mb-2" id="user-input" >',
                ...
                '<button disabled id="post-but" type="button" class="btn" aria-label="filter" >',
                    '<svg class="nbi-btn">',
...
//                                    '</svg>',
        ...
        'notification-container' : '<div id="notifications" style="position:absolute;opacity:0.9;z-index:10000;width:100%"></div>',
